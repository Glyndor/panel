...
INSERT INTO permissions (id, key) VALUES
    (gen_random_uuid(), 'vps:read'),
    (gen_random_uuid(), 'vps:create'),
    (gen_random_uuid(), 'vps:edit'),
    (gen_random_uuid(), 'vps:delete'),
    (gen_random_uuid(), 'vps:*'),
    (gen_random_uuid(), 'org:read'),
    (gen_random_uuid(), 'org:create'),
    (gen_random_uuid(), 'org:edit'),
    (gen_random_uuid(), 'org:delete'),
    (gen_random_uuid(), 'org:*'),
    (gen_random_uuid(), 'project:read'),
    (gen_random_uuid(), 'project:create'),
    (gen_random_uuid(), 'project:edit'),
    (gen_random_uuid(), 'project:delete'),
    (gen_random_uuid(), 'project:*'),
    (gen_random_uuid(), '*:*');
