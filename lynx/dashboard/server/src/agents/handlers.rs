...
// --------------------------------------------------------------------------
// GET /agents/:id/nftables-status
// Returns the latest unresolved nftables_divergence event, if any.
// --------------------------------------------------------------------------
...
// --------------------------------------------------------------------------
// POST /agents/:id/nftables-resolve — restore | accept
// --------------------------------------------------------------------------

#[derive(Debug, Deserialize)]
pub struct NftablesResolveRequest {
    pub action: String, // "restore" | "accept"
}
...
pub async fn nftables_resolve(
    ...
    // Record the resolution event in dashboard DB
